...
if vim.env.TMUX then
  ...
  -- Force redraw on focus to fix visual artifacts
...
-- Move by visual lines (wrapped lines) by default
...
-- NOTE: These keymaps are disabled in favor of vim-tmux-navigator
...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      -- Per-server overrides live in lsp/ directory (e.g. lsp/lua_ls.lua)
      vim.lsp.config('*', {
